...
public class Exercises {
    ...
    private static int calculateFactorial(int number) {
        //Fix this code
        int result = 1;
        for (int i = number; i >= 1; i -= 1) { //error was 2
    ...
    private static void exercise2() {
        ...
        System.out.println("Reversed string of " + input + " is " + reversedString);
    ...
    private static String reverseString(String input) {
        //Fix this code
        String reversed = "";
        for (int i = input.length() - 1; i >= 0; i--) { //changed 1 to 0
            System.out.println("i = " + i + ", reversed = " + reversed);
            reversed +=  input.charAt(i); //error was here
        }
        return reversed;
    }
    ...
    private static boolean isPositive(int num) {
        ...
        return num > 0; // error was >= because zero is neither positive nor negative
    }
}
