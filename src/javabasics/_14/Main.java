...
public class Main {
    ...
    private static void exercise3() {
        ...
        for (
                int index = 0;
                //index < names.size();// <---- previous line
    ...
    private static void exercise4() {
        for (
                //int timesTableCurrentValue = 5; // <---- previous line
                //timesTableCurrentValue <= 50; // <---- previous line
                //timesTableCurrentValue = timesTableCurrentValue + 5 // <---- previous line
    ...
    private static void exercise5() {
        for (int timesTableNumber = 1; timesTableNumber <= 10; timesTableNumber++) {
            // Your fori loop here
        System.out.print("Multiplication table for " + timesTableNumber + ": ");
        for (int i = 1; i <= 10; i++) {
