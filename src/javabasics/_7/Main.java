...
public class Main {
    ...
    private static void exercise1() {
        ...
        String firstNameIsWeird = "Lucas is weird";
        System.out.println(firstNameIsWeird.toUpperCase());
        System.out.println(firstNameIsWeird.toLowerCase());
    }
    ...
    private static void exercise2() {
        ...
        String middleName = "Strong-arm";
        String lastName = "Lucius";
