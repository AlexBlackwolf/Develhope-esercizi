...
public class Main {
    ...
    private static void exercise3() {
        ...
        double ourTestScore = 8;  //if i change the score i can manipulate the result like Getting C if i set 8 to 7
        ...
        } else if (ourTestScore >= 0.6 * maxTestScore && !isTestRetry) {
