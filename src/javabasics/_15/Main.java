...
public class Main {
     ...
     * A1:A A do-while loop would work best, as we want to prompt the user for input at least once,
     * and then continue to prompt them for input until they choose to exit
     *
     * Q2: We have a list of 1000 users to send emails to
     * A2:A for each loop would work best, as we want to iterate through each user in the list and send them an email.
     *
     * Q3: We want to print out the first 80 customer names from our bank database
     * A3:A fori loop would work best, as we want to iterate through the first 80 customers by their index in the database.
     *
     * Q4: We want to read a file 100 lines at a time, without loading the full file into our program
     * A4:
     *  A while loop would work best, as we want to continue reading lines from the file until we have read 100 lines,
     *  and then start again with the next 100 lines until we reach the end of the file.
     */
}
