...
public class Main {
    ...
    private static void exercise4Bonus() {
        ...
        // Ceiling -> takes number to next whole number, if there are any non-zero decimal places.
        System.out.println(ourValue + " after using ceiling=" + Math.ceil(ourValue));
        // Floor -> takes number to previous whole number, if there are any non-zero decimal places
        System.out.println(ourValue + " after using floor=" + Math.floor(ourValue));
        // Round -> Takes number to next whole number if decimal place is .5 or above, otherwise takes it to previous whole number
        System.out.println(ourValue + " after using round=" + Math.round(ourValue));
        // Pow (2) -> Squares our number
        System.out.println(ourValue + " after using powerOf with the value of 2=" + Math.pow(ourValue, 2));
        // Pow (3) -> Cubes our number
        System.out.println(ourValue + " after using powerOf with the value of 3=" + Math.pow(ourValue, 3));
        // Random -> generates a random value between 0-1, we then times this by our number
