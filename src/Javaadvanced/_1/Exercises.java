...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        if (ourSet.containsAll(Set.of(1, 5, 2))) { //add to remove the multiple ones in the if function to fix error, This error occurs because the Set.of()
            // method is trying to create a new set with the same element (1) multiple times.
            // The Set.of() method only accepts unique elements, and it throws an IllegalArgumentException if there are duplicates.
